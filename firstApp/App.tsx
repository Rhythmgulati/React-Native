    ...
    <SafeAreaView style={[styles.main, {}]}>
      <ScrollView>
        <View style={{ marginHorizontal: 20 }}>
          ...
          >
            <Text style={{ fontSize: 24 }}>First App</Text>
          </View>
          <View>
            <Text style={{ marginTop: 20 }}>Scroll Card </Text>
            <ScrollView
              horizontal
              style={{
                borderRadius: 4,
          ...
          <Text style={{ marginTop: 20 }}>Flex Card </Text>
          <View
            style={{
              flex: 1,
              flexWrap: 'wrap',
          ...
          <Text style={{ marginTop: 20 }}>Image Card </Text>
          <View
            style={{
              width: '100%',
              height: 250,
